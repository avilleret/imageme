...
try:
    ...
    # don't enable PIL since it doesn't work
    # PIL_ENABLED = True
...
def _create_index_file(
    ...
    header_text = \
        'TimeLapse de la serre: '  + str(len(image_files)) + ' image(s)'
    html = [
        '<!DOCTYPE html>',
        '<html>',
        '    <head>',
    ...
    for image_file in image_files:
        ...
        image_src_array += "'" + img_src + "'"
        if image_file != image_files[len(image_files)-1]:
            image_src_array += ','
    ...
    html += [
        ...
        '    <p>FPS: <span id="speed_value">1</span> <input type="range" min="0" max="25" value="1" class="slider" id="speed"></p>',
    ]
    html += [
        '    </div>',
        ...
        '      var image_src_array = [ ' + image_src_array + ' ];',
        '      var interval = setInterval(load_next_image, 1000);',
        '      var index = 0',
        '      output.innerHTML = slider.value;',
        '      slider.oninput = function() {',
        '        output.innerHTML = this.value + " " + image_src_array[this.value];',
        '        console.log("slider value: " + this.value + " " + image_src_array[this.value]);',
        '        img.setAttribute(\'src\', image_src_array[this.value]);',
        '        index = this.value;',
        '      }',
        '      ',
        '      function bodyLoadCallback() {',
        ...
        '        if(index < image_src_array.length)',
        '        {',
        '          index++;',
        '          slider.value = index;',
        '          output.innerHTML = slider.value + " " + image_src_array[slider.value];',
        ...
        '        if(this.value > 0)',
        '           interval = setInterval(load_next_image, 1000/this.value);',
        '      }',
        '    </script>',
        '    </body>',
        '</html>'
